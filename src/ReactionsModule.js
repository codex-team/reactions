...
var identifier_ts_1 = require("./identifier.ts");
/**
 * @class Reactions
...
var Reactions = /** @class */ (function () {
    ...
    function Reactions(data) {
        ...
        this.id = new identifier_ts_1.default(data.id);
     ...
     */
    Reactions.getRandomValue = function () {
     ...
     */
    Reactions.loadValue = function (key) {
     ...
     */
    Reactions.saveValue = function (key, value) {
     ...
     * @param {number} userId
     */
    Reactions.setUserId = function (userId) {
    ...
    Reactions.prototype.addReaction = function (item, i) {
        ...
        var votes = Reactions.loadValue(storageKey);
        if (!votes) {
            votes = 0;
    ...
    Reactions.prototype.unvote = function (index) {
        ...
        var votes = Reactions.loadValue(storageKey) - 1;
     ...
     */
    Reactions.userId = localStorage.getItem('reactionsUserId') || Reactions.getRandomValue();
    return Reactions;
}());
exports.default = Reactions;
//# sourceMappingURL=ReactionsModule.js.map